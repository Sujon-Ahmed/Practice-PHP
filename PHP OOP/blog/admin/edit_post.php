            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                    <form action="update_post.php" id="post" method="POST" enctype="multipart/form-data">                        
                            <div class="row">
                                <div class="col-md-10 m-auto">
                                    
                                    <label for="post_title" class="mt-1">Post Title</label>
                                    <input type="text" value="<?php echo $title; ?>" name="title" data-parsley-trigger="keyup" data-parsley-minlength="3" class="form-control mb-1 mt-1" placeholder="Post Title" id="post_title" required>
                                        ...
                                        <?php
                                            if($cat->num_rows > 0){
                                                while($cat_row = $cat->fetch_object()){
                                                    ?>
                                                        <option <?php if($category_id == $cat_row->cat_id){echo 'selected';}  ?> value="<?php echo $cat_row->cat_id; ?>"><?php echo $cat_row->cat_name; ?></option>
                                                    <?php
                                                }
                                            }
                                        ?>
                                    ...
                                    <div class="form-row mt-3"> 
                                        ...
                                        <div id="post-test-img" class="form-group col-md-6 mt-3">
                                            <img style="width: 200px; height:auto;" src="<?php echo 'uploads/posts/'.$image; ?>" alt="">
                                        </div>
                                    </div>

                                    <label for="post_description" class="mt-1">Post Description</label>
                                    <textarea name="body" id="description" class="form-control " cols="10" rows="5" required><?php echo $body; ?></textarea>
