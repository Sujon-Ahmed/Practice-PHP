            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                            <h2 class="text-capitalize mb-3">post thumbnail</h2>
                            <img class="img-fluid" src="<?php echo 'uploads/posts/'.$image; ?>" width="400" alt="">
                            <h2 class="text-capitalize mb-3 mt-3">post body</h2>
                            <div>
                                <?php echo $body; ?>
                            </div>
                            </div>
